...
def get_validation_percentage(config: dict) -> float:
    """
    Get the validation percentage from the configuration dictionary.

    Args:
        config (dict): The configuration dictionary.

    Returns:
        float: The validation percentage.
    """
    return config.get("validation_split", 0.2)
